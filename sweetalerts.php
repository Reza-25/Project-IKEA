...
<ul>
<li><a href="sweetalerts.html" class="active">Sweet Alerts</a></li>
...
<button type="button" class="btn btn-outline-primary mb-2" id="confirm-color">Confirm Button Color</button>
</div>
</div>
