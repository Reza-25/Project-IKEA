    ...
    <div class="page-header">
      <div class="d-flex justify-content-between align-items-center">
        <div class="page-title">
          <h4 style="font-size: 1.1rem;">Product Category list</h4>
          <h6 style="font-size: 0.9rem;">View/Search product Category</h6>
        </div>
        <div class="page-btn">
          <a href="addcategory.php" class="btn btn-added btn-sm">
            <img src="../assets/img/icons/plus.svg" class="me-1" alt="img" style="width: 14px;">Add Category
          </a>
        </div>
      </div>
    </div>

    <!-- Revenue, Suppliers, Product Sold, Budget Spent - Lebih Kompak -->
