            ...
            <ul>
              ...
              <li class="submenu">
                ...
                <ul>
                  ...
                  <li><a href="storelist.php" class="active">Store List</a></li>
      ...
      <div class="page-wrapper">
        <div class="content">
          <div class="page-header">
            ...
            <div class="page-btn">
              <a href="addstore.php" class="btn btn-added"><img src="../assets/img/icons/plus.svg" alt="img" class="me-2" />Add Store</a>
            </div>
          </div>
                ...
                <table class="table datanew">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a class="me-3" href="editstore.php">
