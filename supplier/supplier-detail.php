...
<hr class="m-0">
<a class="dropdown-item logo1ut pb-0" href="../signin.php"><img src="../assets/img/icons/log-out.svg" class="me-2" alt="img">Logo1ut</a>
</div>
</div>
</li>
</ul>
...
<a class="dropdown-item" href="../signin.php">Logo1ut</a>
</div>
</div>
...
<ul>
<li><a href="../return/salesreturnlist.php">Sales Return List</a></li>
<li><a href="../return/createsalesreturn.php">Add Sales Return </a></li>
<li><a href="../return/purchasereturnlists.php">Purchase Return List</a></li>
...
<font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> Delivered</font></font><br>
...
<tr class="details" style="border-bottom: solid #E9ECEF ;">
<td style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
